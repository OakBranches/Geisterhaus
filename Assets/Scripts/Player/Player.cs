...
public class Player : MonoBehaviour
{
    ...
    IEnumerator SmoothCameraPosition(Vector3 toWhere, Vector3 playerToWhere)
    {
        Time.timeScale = 0f;
        ...
        Time.timeScale = 1f;
        gameObject.transform.position = playerToWhere;
    }
}